...
NATIVE_PROTOCOL_ROUTES = [('indiehackers', 'indiehackers', 'rss'),
 ...
 ('coindesk_news', 'coindesk-news', 'rsshub'),
 ...
 ('anthropic_research', 'anthropic-research', 'rsshub'),
 ('anthropic_engineering', 'anthropic-engineering', 'rsshub'),
 ...
 ('tencent_hunyuan', 'tencent-hunyuan', 'rss'),
 ...
 ('qbitai_embodied', 'qbitai-embodied', 'rsshub'),
