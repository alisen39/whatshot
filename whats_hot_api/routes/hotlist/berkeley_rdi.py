...
ROUTE_NAME = 'berkeley-rdi'
SOURCE_LINK = 'https://rdi.berkeley.edu/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Ardi.berkeley.edu&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Berkeley RDI',
    "description": 'Berkeley RDI research on AI safety and evaluation.',
    "link": SOURCE_LINK,
}
