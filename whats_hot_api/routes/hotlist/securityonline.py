...
ROUTE_NAME = 'securityonline'
SOURCE_LINK = 'https://securityonline.info/'
FEED_URL = 'https://securityonline.info/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'SecurityOnline',
    "description": 'Cybersecurity news, vulnerabilities, and threat research.',
    "link": SOURCE_LINK,
}
