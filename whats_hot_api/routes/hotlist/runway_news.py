...
ROUTE_NAME = 'runway-news'
SOURCE_LINK = 'https://runwayml.com/news/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Arunwayml.com%2Fnews%20Runway&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Runway News',
    "description": 'Runway product, research, and company news.',
    "link": SOURCE_LINK,
}
