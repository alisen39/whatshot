...
ROUTE_NAME = 'techcrunch-ai'
SOURCE_LINK = 'https://techcrunch.com/category/artificial-intelligence/'
FEED_URL = 'https://techcrunch.com/category/artificial-intelligence/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'TechCrunch · AI',
    "description": 'TechCrunch coverage focused on artificial intelligence.',
    "link": SOURCE_LINK,
}
