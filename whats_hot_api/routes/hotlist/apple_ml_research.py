...
ROUTE_NAME = 'apple-ml-research'
SOURCE_LINK = 'https://machinelearning.apple.com/'
FEED_URL = 'https://machinelearning.apple.com/rss.xml'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Apple Machine Learning Research',
    "description": 'Apple machine learning research papers and notes.',
    "link": SOURCE_LINK,
    "params": {
        "type": {
            "name": "内容分类",
            "type": {"ml-research": "Machine Learning Research"},
        }
    },
}
