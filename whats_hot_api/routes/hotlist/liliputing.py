...
ROUTE_NAME = 'liliputing'
SOURCE_LINK = 'https://liliputing.com/'
FEED_URL = 'https://liliputing.com/feed'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Liliputing',
    "description": 'Mobile computing, mini PCs, and portable hardware news.',
    "link": SOURCE_LINK,
}
