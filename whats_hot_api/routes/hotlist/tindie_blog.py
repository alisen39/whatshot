...
ROUTE_NAME = 'tindie-blog'
SOURCE_LINK = 'https://blog.tindie.com/'
FEED_URL = 'https://blog.tindie.com/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Tindie Blog',
    "description": 'Independent hardware maker and marketplace updates.',
    "link": SOURCE_LINK,
}
