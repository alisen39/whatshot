...
ROUTE_NAME = 'dario-amodei'
SOURCE_LINK = 'https://darioamodei.com/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Adarioamodei.com%20Dario%20Amodei&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Dario Amodei',
    "description": 'Essays and public writing from Dario Amodei.',
    "link": SOURCE_LINK,
}
