...
ROUTE_NAME = "arxiv-cs-cl"
SOURCE_LINK = "https://arxiv.org/list/cs.CL/recent"
FEED_URL = (
    "https://export.arxiv.org/api/query?search_query=cat%3Acs.CL&start=0&"
...
async def _get_list(no_cache: bool) -> dict:
    ...
    if not data:
        raise RuntimeError("arXiv cs.CL response is not a non-empty Atom feed")
    return {
