...
ROUTE_NAME = 'ros-discourse'
SOURCE_LINK = 'https://discourse.ros.org/'
FEED_URL = 'https://discourse.ros.org/latest.rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'ROS Discourse',
    "description": 'ROS community releases, questions, and project updates.',
    "link": SOURCE_LINK,
}
