...
ROUTE_NAME = 'singularity-hub'
SOURCE_LINK = 'https://singularityhub.com/'
FEED_URL = 'https://singularityhub.com/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Singularity Hub',
    "description": 'Future-focused coverage of AI, science, and robotics.',
    "link": SOURCE_LINK,
}
