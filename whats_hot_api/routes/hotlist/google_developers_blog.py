...
ROUTE_NAME = 'google-developers-blog'
SOURCE_LINK = 'https://developers.googleblog.com/'
FEED_URL = 'https://developers.googleblog.com/feeds/posts/default?alt=rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Google Developers Blog',
    "description": 'Google developer platform and API updates.',
    "link": SOURCE_LINK,
    "params": {
        "type": {
            "name": "内容分类",
            "type": {"developers": "Developers Blog"},
        }
    },
}
