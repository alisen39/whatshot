...
ROUTE_NAME = 'engadget-robotics'
SOURCE_LINK = 'https://www.engadget.com/science/robotics/'
FEED_URL = 'https://www.engadget.com/category/robotics/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Engadget · Robotics',
    "description": 'Consumer-friendly robotics coverage from Engadget.',
    "link": SOURCE_LINK,
}
