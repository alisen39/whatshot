...
ROUTE_NAME = 'transformer-circuits'
SOURCE_LINK = 'https://transformer-circuits.pub/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Atransformer-circuits.pub&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Transformer Circuits',
    "description": 'Anthropic interpretability research articles.',
    "link": SOURCE_LINK,
}
