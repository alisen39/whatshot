...
ROUTE_NAME = 'robotics-tomorrow'
SOURCE_LINK = 'https://www.roboticstomorrow.com/'
FEED_URL = 'https://www.roboticstomorrow.com/rss/news/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Robotics Tomorrow',
    "description": 'Robotics and automation industry headlines.',
    "link": SOURCE_LINK,
}
