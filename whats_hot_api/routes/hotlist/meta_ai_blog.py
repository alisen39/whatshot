...
ROUTE_NAME = 'meta-ai-blog'
SOURCE_LINK = 'https://ai.meta.com/blog/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Aai.meta.com%2Fblog&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Meta AI Blog',
    "description": 'Meta AI research and product updates.',
    "link": SOURCE_LINK,
}
