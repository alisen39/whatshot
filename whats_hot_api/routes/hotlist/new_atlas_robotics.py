...
ROUTE_NAME = 'new-atlas-robotics'
SOURCE_LINK = 'https://newatlas.com/robotics/'
FEED_URL = 'https://newatlas.com/robotics/index.rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'New Atlas · Robotics',
    "description": 'Robotics coverage across research, devices, and unusual machines.',
    "link": SOURCE_LINK,
}
