...
ROUTE_NAME = 'eleutherai-blog'
SOURCE_LINK = 'https://blog.eleuther.ai/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Ablog.eleuther.ai&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'EleutherAI Blog',
    "description": 'EleutherAI open model and research updates.',
    "link": SOURCE_LINK,
}
