...
ROUTE_NAME = 'claude-blog'
SOURCE_LINK = 'https://claude.com/blog'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Aclaude.com%2Fblog%20Claude&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Claude Blog',
    "description": 'Claude product updates and practical announcements.',
    "link": SOURCE_LINK,
}
