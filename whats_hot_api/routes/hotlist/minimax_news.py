...
ROUTE_NAME = 'minimax-news'
SOURCE_LINK = 'https://www.minimaxi.com/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Aminimaxi.com%20MiniMax&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'MiniMax',
    "description": 'MiniMax model and product news.',
    "link": SOURCE_LINK,
}
