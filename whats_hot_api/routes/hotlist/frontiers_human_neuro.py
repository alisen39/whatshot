...
ROUTE_NAME = 'frontiers-human-neuro'
SOURCE_LINK = 'https://www.frontiersin.org/journals/human-neuroscience'
FEED_URL = 'https://www.frontiersin.org/journals/human-neuroscience/rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Frontiers in Human Neuroscience',
    "description": 'Human neuroscience research articles and journal updates.',
    "link": SOURCE_LINK,
    "params": {
        "type": {
            "name": "内容分类",
            "type": {"human-neuro": "Human Neuroscience"},
        }
    },
}
