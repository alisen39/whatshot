...
ROUTE_NAME = 'open-robotics-blog'
SOURCE_LINK = 'https://www.openrobotics.org/blog'
FEED_URL = 'https://www.openrobotics.org/blog?format=rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Open Robotics Blog',
    "description": 'Official Open Robotics and OSRA ecosystem updates.',
    "link": SOURCE_LINK,
}
