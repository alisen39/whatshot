...
ROUTE_NAME = 'mit-tech-review-ai'
SOURCE_LINK = 'https://www.technologyreview.com/topic/artificial-intelligence/'
FEED_URL = 'https://www.technologyreview.com/topic/artificial-intelligence/feed'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'MIT Tech Review · AI',
    "description": 'Technology Review coverage focused on AI.',
    "link": SOURCE_LINK,
    "params": {
        "type": {
            "name": "内容分类",
