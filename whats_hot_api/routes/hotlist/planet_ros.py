...
ROUTE_NAME = 'planet-ros'
SOURCE_LINK = 'https://planet.ros.org/'
FEED_URL = 'https://planet.ros.org/rss20.xml'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Planet ROS',
    "description": 'Aggregated ROS ecosystem posts, releases, and discussions.',
    "link": SOURCE_LINK,
}
