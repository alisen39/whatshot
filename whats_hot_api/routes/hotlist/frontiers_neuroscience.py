...
ROUTE_NAME = 'frontiers-neuroscience'
SOURCE_LINK = 'https://www.frontiersin.org/journals/neuroscience'
FEED_URL = 'https://www.frontiersin.org/journals/neuroscience/rss'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Frontiers in Neuroscience',
    "description": 'Neuroscience research articles and journal updates.',
    "link": SOURCE_LINK,
}
