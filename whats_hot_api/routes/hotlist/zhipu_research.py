...
ROUTE_NAME = 'zhipu-research'
SOURCE_LINK = 'https://www.zhipu.ai/'
FEED_URL = 'https://news.google.com/rss/search?q=Zhipu%20AI%20research%20model&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Zhipu AI Research',
    "description": 'Zhipu AI research and model updates.',
    "link": SOURCE_LINK,
}
