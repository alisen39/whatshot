...
ROUTE_NAME = 'mit-news-robotics'
SOURCE_LINK = 'https://news.mit.edu/topic/robotics'
FEED_URL = 'https://news.mit.edu/topic/mitrobotics-rss.xml'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'MIT News · Robotics',
    "description": 'MIT robotics research and lab news.',
    "link": SOURCE_LINK,
}
