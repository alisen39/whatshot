...
ROUTE_NAME = 'xai-news'
SOURCE_LINK = 'https://x.ai/news'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Ax.ai%2Fnews&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'xAI News',
    "description": 'Official xAI product and company news.',
    "link": SOURCE_LINK,
}
