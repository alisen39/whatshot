...
ROUTE_NAME = 'deepseek-github'
SOURCE_LINK = 'https://github.com/deepseek-ai/'
FEED_URL = 'https://news.google.com/rss/search?q=DeepSeek%20GitHub%20release%20repository&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'DeepSeek GitHub',
    "description": 'DeepSeek organization activity from GitHub.',
    "link": SOURCE_LINK,
}
