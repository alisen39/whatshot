...
ROUTE_NAME = 'apnews-technology'
SOURCE_LINK = 'https://apnews.com/hub/technology'
RSSHUB_ROUTE = '/apnews/rss/technology'
RSSHUB_PARAMS: dict[str, str | int | bool] = {}
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'AP News · Technology',
    "description": 'Technology news from the Associated Press.',
    "link": SOURCE_LINK,
}
