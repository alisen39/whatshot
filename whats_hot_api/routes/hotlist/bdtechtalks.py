...
ROUTE_NAME = 'bdtechtalks'
SOURCE_LINK = 'https://bdtechtalks.com/'
FEED_URL = 'https://bdtechtalks.com/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'BD Tech Talks',
    "description": 'Accessible analysis of AI, robotics, and emerging tech.',
    "link": SOURCE_LINK,
}
