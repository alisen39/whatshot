...
ROUTE_NAME = 'ithome-ranking-24h'
SOURCE_LINK = 'https://www.ithome.com/'
RSSHUB_ROUTE = '/ithome/ranking/24h'
RSSHUB_PARAMS: dict[str, str | int | bool] = {}
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'IT之家 · 24h 热榜',
    "description": "Chinese consumer technology headlines from IT Home's 24-hour ranking.",
    "link": SOURCE_LINK,
}
