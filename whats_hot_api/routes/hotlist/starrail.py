...
async def _get_list(type_param: str, no_cache: bool) -> dict:
    url = f"https://bbs-api-static.miyoushe.com/painter/wapi/getNewsList?client_type=4&gids=6&page_size=20&type={type_param}"
    ...
    return {
        ...
        "data": [
            ListItem(
                ...
                url=f"https://www.miyoushe.com/sr/article/{v['post']['post_id']}",
                mobileUrl=f"https://m.miyoushe.com/sr/#/article/{v['post']['post_id']}",
            )
            for v in items
        ],
    }
