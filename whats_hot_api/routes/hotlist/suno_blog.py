...
ROUTE_NAME = 'suno-blog'
SOURCE_LINK = 'https://suno.com/blog/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Asuno.com%2Fblog%20Suno&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Suno Blog',
    "description": 'Suno music AI product and company updates.',
    "link": SOURCE_LINK,
}
