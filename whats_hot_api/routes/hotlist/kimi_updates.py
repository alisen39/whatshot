...
ROUTE_NAME = 'kimi-updates'
SOURCE_LINK = 'https://kimi.moonshot.cn/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Akimi.moonshot.cn%20OR%20site%3Akimi.com%20Kimi&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Moonshot AI Kimi',
    "description": 'Moonshot AI and Kimi product or model updates.',
    "link": SOURCE_LINK,
}
