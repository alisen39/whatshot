...
ROUTE_NAME = 'lmsys-blog'
SOURCE_LINK = 'https://lmsys.org/blog/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Almsys.org%2Fblog&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'LMSYS Blog',
    "description": 'LMSYS and Chatbot Arena research updates.',
    "link": SOURCE_LINK,
}
