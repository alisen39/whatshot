...
ROUTE_NAME = 'boston-dynamics'
SOURCE_LINK = 'https://blog.bostondynamics.com/'
FEED_URL = 'https://blog.bostondynamics.com/rss.xml'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Boston Dynamics Blog',
    "description": 'Company updates on robotics products and deployments.',
    "link": SOURCE_LINK,
}
