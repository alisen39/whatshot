...
ROUTE_NAME = 'cursor-blog'
SOURCE_LINK = 'https://www.cursor.com/blog'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Acursor.com%2Fblog%20Cursor&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Cursor Blog',
    "description": 'Cursor editor product and AI coding updates.',
    "link": SOURCE_LINK,
}
