...
ROUTE_NAME = 'cmu-ml-blog'
SOURCE_LINK = 'https://blog.ml.cmu.edu/'
FEED_URL = 'https://blog.ml.cmu.edu/feed/'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'CMU Machine Learning Blog',
    "description": 'Machine learning research notes from Carnegie Mellon.',
    "link": SOURCE_LINK,
}
