...
SOURCE_LINK = 'https://hunyuan.tencent.com/'
FEED_URL = 'https://news.google.com/rss/search?q=site%3Ahunyuan.tencent.com&hl=en-US&gl=US&ceid=US%3Aen'
ROUTE_META: dict = {
    "name": ROUTE_NAME,
    "title": 'Tencent Hunyuan Research',
    "description": 'Tencent Hunyuan model and research updates.',
    "link": SOURCE_LINK,
}
